...
if __name__ == '__main__':
    ...
    # create database
    bbdd.create_database("prueba1.db")
...
#    bbdd.open_database("prueba.db")
    ...
    #therapist
    result, therapist = bbdd.new_therapist(nombre="Luis Perez", username="luisperez" , hash="$pbkdf2-sha256$29000$Qegdg9Aa45xzzhkjxFgL4Q$T2WhJc.EeWDVIH1WAmwsFbeG5ELdTe5pClMZthcoMgU" , salt="" , centro="Badajoz" , telefono="927296677" , profesion="lasuya" , observaciones="todas" , fechaAlta="20191010")
