...
class LoginWindow(QWidget): # crea widget vacio
    def __init__(self,parent = None):
        ...
        file = QFile("/home/robocomp/robocomp/components/euroage-tv/components/gameManager/src/login.ui")
...
class RegisterWindow(QWidget): # crea widget vacio
    def __init__(self,parent = None):
        ...
        file = QFile("/home/robocomp/robocomp/components/euroage-tv/components/gameManager/src/register.ui")
        file.open(QFile.ReadOnly)
        self.ui = loader.load(file, self.parent())
        self.mylayout.addWidget(self.ui)
        self.mylayout.setContentsMargins(0,0,0,0)
...
class UsersWindow(QWidget): # crea widget vacio
    def __init__(self,parent = None):
        ...
        file = QFile("/home/robocomp/robocomp/components/euroage-tv/components/gameManager/src/usersv2.ui")
        file.open(QFile.ReadOnly)
        self.ui = loader.load(file, self.parent())
        self.mylayout.addWidget(self.ui)
        self.mylayout.setContentsMargins(0,0,0,0)
...
class PlayersWindow(QWidget): # crea widget vacio
    def __init__(self,parent = None):
        ...
        file = QFile("/home/robocomp/robocomp/components/euroage-tv/components/gameManager/src/player.ui")
        file.open(QFile.ReadOnly)
        self.ui = loader.load(file, self.parent())
        self.mylayout.addWidget(self.ui)
        self.mylayout.setContentsMargins(0,0,0,0)
...
class GameWindow(QWidget): # crea widget vacio
    def __init__(self,parent = None):
        ...
        file = QFile("/home/robocomp/robocomp/components/euroage-tv/components/gameManager/src/AdminInterface.ui")
        file.open(QFile.ReadOnly)
        self.ui = loader.load(file, self.parent())
        self.mylayout.addWidget(self.ui)
        self.mylayout.setContentsMargins(0,0,0,0)
