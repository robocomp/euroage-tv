...
#
# Just: "${PATH_TO_BINARY}/gameManager --Ice.Config=${PATH_TO_CONFIG_FILE}"
#
...
if __name__ == '__main__':
    ...
    try:
        ...
        try:
            ...
            admingame_proxy = EuroAgeGamesAdmin.AdminGamePrx.uncheckedCast(basePrx)
    ...
    gamemetricsI_ = gamemetricsI.GameMetricsI(worker)
