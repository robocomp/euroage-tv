...
#Signals for State Machine
	...
	create_playertosesion_init = QtCore.Signal()
	...
	pausedtowait_play = QtCore.Signal()
...
#Initialization State machine
		...
		self.create_player_state.addTransition(self.create_playertosesion_init, self.sesion_init_state)
		...
		self.paused_state.addTransition(self.pausedtowait_play, self.wait_play_state)
